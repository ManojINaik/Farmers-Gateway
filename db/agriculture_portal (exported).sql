...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2024 at 05:54 PM
...
INSERT INTO `cart` (`id`, `crop_id`, `farmer_id`, `quantity`, `price`, `cust_id`, `created_at`) VALUES
(3, 4, 44, 1.00, 78.00, 1, '2024-12-12 16:51:31');
...
(106, 44, 'barley', -16, 1, 2),
(107, 44, 'urad', 45, 45, 182),
(108, 44, 'soyabean', 34, 56, 78),
(109, 44, 'rice', -135, 56, 84),
(110, 44, 'ragi', -538, 90, 126),
(111, 44, 'wheat', 45, 66, 99),
(112, 44, 'urad', 45, 45, 182),
(113, 44, 'soyabean', 54, 53, 78),
(114, 44, 'urad', 55, 56, 182),
(115, 44, 'soyabean', 34, 45, 78),
(116, 44, 'urad', 354, 33, 182),
(117, 44, 'ragi', -561, 78, 126),
(118, 44, 'urad', 343, 424, 182),
(119, 44, 'wheat', 56, 66, 99),
(120, 44, 'cotton', -2723, 78, 107),
(121, 44, 'cotton', 997198, 78, 107),
(122, 44, 'gram', 90000, 89, 134),
(123, 61, 'wheat', 545477, 65, 99),
(124, 61, 'jowar', 456, 46, 69),
(125, 61, 'cotton', 50295, 56, 107),
(126, 61, 'potato', 55, 40, 60),
(127, 44, 'tomato', 300, 40, 60),
(128, 44, 'cotton', 4, 71, 107);
...
(4, 'agricultureportal01@gmail.com', 'farmer', 'fssdfsdf', 'fwfwfw', 1, '1733139858_Recording 2024-10-04 145738.mp4', 'Crop Farming', '2024-12-02 17:14:18', 64, '0:11', '1733139858_Screenshot 2024-09-14 103106.png', 3, 0);
...
(1, 'ORD17335883229386', 1, 52500.00, '2024-12-07 17:18:42', 'cod', NULL, 'completed', 'Mangalore Karnataka', '07676445273', '2024-12-07 16:18:42', '2024-12-10 09:04:19'),
(2, 'ORD17335891154103', 1, 2394865.00, '2024-12-07 17:31:55', 'cod', NULL, 'pending', 'Mangalore Karnataka', '07676445273', '2024-12-07 16:31:55', '2024-12-07 16:31:55'),
(3, 'ORD17335900075369', 1, 18000.00, '2024-12-07 17:46:47', 'cod', NULL, 'pending', 'Mangalore Karnataka', '07676445273', '2024-12-07 16:46:47', '2024-12-07 16:46:47'),
(4, 'ORD17335901261744', 1, 265125.00, '2024-12-07 17:48:46', 'cod', NULL, 'pending', 'Mangalore Karnataka', '07676445273', '2024-12-07 16:48:46', '2024-12-07 16:48:46'),
(5, 'ORD17335903997388', 1, 424125.00, '2024-12-07 17:53:19', 'cod', NULL, 'pending', 'Mangalore Karnataka', '07676445273', '2024-12-07 16:53:19', '2024-12-07 16:53:19'),
(9, 'ORD67551763a115a', 1, 2700.00, '2024-12-08 04:49:55', 'cod', NULL, 'pending', 'Mangalore Karnataka', '7676445273', '2024-12-08 03:49:55', '2024-12-08 03:49:55'),
(10, 'ORD675517cac145e', 1, 408900.00, '2024-12-08 04:51:38', 'cod', NULL, 'pending', 'Mangalore Karnataka', '7676445273', '2024-12-08 03:51:38', '2024-12-08 03:51:38'),
(14, 'ORD6758038042dc3', 1, 4.80, '2024-12-10 10:01:52', 'cod', NULL, 'pending', 'Mangalore Karnataka', '7676445273', '2024-12-10 09:01:52', '2024-12-10 09:01:52');
...
INSERT INTO `order_items` (`id`, `order_id`, `item_name`, `crop_name`, `quantity`, `price`, `created_at`) VALUES
(1, 'ORD17335883229386', 'cotton', 'cotton', 700.00, 75.00, '2024-12-07 16:18:42'),
(2, 'ORD17335891154103', 'wheat', 'wheat', 43543.00, 55.00, '2024-12-07 16:31:55'),
(3, 'ORD17335900075369', 'jowar', 'jowar', 450.00, 40.00, '2024-12-07 16:46:47'),
(4, 'ORD17335903997388', 'cotton', 'cotton', 5655.00, 75.00, '2024-12-07 16:53:19'),
(5, 'ORD675517cac145e', 'cotton', 'cotton', 5452.00, 75.00, '2024-12-08 03:51:38');
...
ALTER TABLE `cart`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_crop_farmer_customer` (`crop_id`,`farmer_id`,`cust_id`),
...
ALTER TABLE `farmer_crops`
  ...
  ADD KEY `fk_farmercrop_farmer` (`farmer_id`);
...
--
ALTER TABLE `farmer_crops_trade`
  MODIFY `trade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_crop_fk` FOREIGN KEY (`crop_id`) REFERENCES `crops` (`Crop_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `cart_customer_fk` FOREIGN KEY (`cust_id`) REFERENCES `custlogin` (`cust_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `cart_farmer_fk` FOREIGN KEY (`farmer_id`) REFERENCES `farmerlogin` (`farmer_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `farmer_crops`
  ADD CONSTRAINT `fk_farmercrop_farmer` FOREIGN KEY (`farmer_id`) REFERENCES `farmerlogin` (`farmer_id`) ON DELETE CASCADE;
